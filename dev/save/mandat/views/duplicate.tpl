	...
	*}
	...
	<fieldset>
		...
		<fieldset class="cinquante">
			...
			<p id="jsEstimMaxi">
				Estimation FAI maxi : <input type="text" name="estimationMaxi"
					id="jsEstimMaxi" value="{$estimationMaxi}" />
			</p>
			<p id="jsMargeNegoce">
		...
		<fieldset>
			...
			<p>
				<label for="chargesMensuelle">Charges mensuelles : <input
			...
			<p>
				<label for="cuisineEquipee">Cuisine équipée : <input
					{if $cuisineEquipee eq 'on'} checked="checked"
					{/if} type="checkbox" name="cuisineEquipee" id="cuisineEquipee"
					value="on" /> </label>
			</p>
			<p>
			...
			<p>
				<label for="heating"> Chauffage : <select name="heating"
					id="heating">
		...
		<fieldset>
			...
			<p>
				Zone BDF : <label for="zonebdfFalse"><input type="radio"
		...
		<fieldset>
			...
			<p>
				Terrain vendu semi viabilisé : <label
					...
					{/if} name="terrainSemiViabilise" id="terrainSemiViabiliseFalse" />Non</label><label
