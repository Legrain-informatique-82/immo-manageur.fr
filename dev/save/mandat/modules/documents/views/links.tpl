{counter start=0 print=false assign=compt}
 ...
 <ul>
	<li><a target="_blank"
		href="{Tools::create_url($user,'documents','afficheEscal',$smarty.get.action)}">Affiche
			classique</a>
	</li>
	</ul>
	</div>
	...
	<!--
    <li> <a target="_blank" href="{Tools::create_url($user,'documents','afficheEscalTerrain',$smarty.get.action)}">Affiche classique</a></li>
	<li> <a target="_blank" href="{Tools::create_url($user,'documents','afficheEscalTerrainExclu',$smarty.get.action)}">Affiche exclu</a></li>
	<li> <a target="_blank" href="{Tools::create_url($user,'documents','afficheEscalTerrainVendu',$smarty.get.action)}">Affiche vendu par escalimmo</a></li>
	-->
	{if $isCompromis}
	  {counter}
	<div class="mSep">
	...
	<ul>
	<li><a target="_blank"
		href="{Tools::create_url($user,'documents','compte_rendu_simple',$smarty.get.action)}">Compte rendu simple</a></li>
	<li><a target="_blank"
		href="{Tools::create_url($user,'documents','envoi_comp_acq',$smarty.get.action)}">Envoi comp acquereur</a></li>
