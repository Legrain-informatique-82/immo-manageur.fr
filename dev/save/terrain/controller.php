...
class Controller extends CoreController {
	...
	private function _treatment( $post,$get){
		...
		elseif(isset($get['page'])&&$get['page']=='updateGen'){
			...
			$this->_smarty->assign('numLot',$numLot);
			$this->_smarty->assign('nature',$nature);
			//		$this->_smarty->assign('superficieParcelle1',$superficieParcelle1);
			//		$this->_smarty->assign('superficieParcelle2',$superficieParcelle2);
			//		$this->_smarty->assign('superficieParcelle3',$superficieParcelle3);
			//		$this->_smarty->assign('superficieAutreParcelle',$superficieAutreParcelle);
			//		$this->_smarty->assign('superficieConstructible',$superficieConstructible);
			//		$this->_smarty->assign('superficieNonConstructible',$superficieNonConstructible);
			//		$this->_smarty->assign('superficieTotale',$superficieTotale);
			//		$this->_smarty->assign('idGeometer',$idGeometer);
			//		$this->_smarty->assign('idBornageTerrain',$idBornageTerrain);
