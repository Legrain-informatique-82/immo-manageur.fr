...
class MandateCommonOwnership
{
	 ...
	 */
	protected function __construct(PDO $pdo,$idMandateCommonOwnership,$name,$code,$easyload=false)
	{
		// Sauvegarder pdo
		$this->pdo = $pdo;
	...
	public static function create(PDO $pdo,$name,$code,$easyload=true)
	{
		...
		$pdoStatement = $pdo->prepare('INSERT INTO MandateCommonOwnership (name,code) VALUES (?,?)');
		...
		return new MandateCommonOwnership($pdo,$pdo->lastInsertId(),$name,$code,$easyload);
	}
	...
	{
		return $pdo->prepare('SELECT m.idMandateCommonOwnership, m.name, m.code FROM MandateCommonOwnership m '.
	...
	public static function loadAll(PDO $pdo,$easyload=false)
	{
		...
		$pdoStatement = MandateCommonOwnership::selectAll($pdo);
	...
	{
		$pdoStatement = MandateCommonOwnership::_select($pdo);
	...
	public static function fetch(PDO $pdo,PDOStatement $pdoStatement,$easyload=false)
	{
		...
		list($idMandateCommonOwnership,$name,$code) = $values;

		// Construire le/la mandateCommonOwnership
		return isset(MandateCommonOwnership::$easyload[$idMandateCommonOwnership.'-'.$name.'-'.$code]) ? MandateCommonOwnership::$easyload[$idMandateCommonOwnership.'-'.$name.'-'.$code] :
		new MandateCommonOwnership($pdo,$idMandateCommonOwnership,$name,$code,$easyload);
	}
	...
	public function serialize($serialize=true)
	{
		...
		$array = array('idMandateCommonOwnership' => $this->idMandateCommonOwnership,'name' => $this->name,'code' => $this->code);
	...
	public static function unserialize(PDO $pdo,$string,$easyload=true)
	{
		...
		new MandateCommonOwnership($pdo,$array['idMandateCommonOwnership'],$array['name'],$array['code'],$easyload);
	}
