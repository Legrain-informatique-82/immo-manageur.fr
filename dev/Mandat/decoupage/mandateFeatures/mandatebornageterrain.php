...
class MandateBornageTerrain
{
	 ...
	 */
	protected function __construct(PDO $pdo,$idMandateBornageTerrain,$name,$code,$easyload=false)
	{
		// Sauvegarder pdo
		$this->pdo = $pdo;
	...
	public static function create(PDO $pdo,$name,$code,$easyload=true)
	{
		...
		$pdoStatement = $pdo->prepare('INSERT INTO MandateBornageTerrain (name,code) VALUES (?,?)');
		...
		return new MandateBornageTerrain($pdo,$pdo->lastInsertId(),$name,$code,$easyload);
	}
	...
	{
		return $pdo->prepare('SELECT m.idMandateBornageTerrain, m.name, m.code FROM MandateBornageTerrain m '.
	...
	{
		$pdoStatement = MandateBornageTerrain::_select($pdo);
	...
	public static function fetch(PDO $pdo,PDOStatement $pdoStatement,$easyload=false)
	{
		...
		list($idMandateBornageTerrain,$name,$code) = $values;

		// Construire le/la mandateBornageTerrain
		return isset(MandateBornageTerrain::$easyload[$idMandateBornageTerrain.'-'.$name.'-'.$code]) ? MandateBornageTerrain::$easyload[$idMandateBornageTerrain.'-'.$name.'-'.$code] :
		new MandateBornageTerrain($pdo,$idMandateBornageTerrain,$name,$code,$easyload);
	}
	...
	public function serialize($serialize=true)
	{
		...
		$array = array('idMandateBornageTerrain' => $this->idMandateBornageTerrain,'name' => $this->name,'code' => $this->code);
	...
	public static function unserialize(PDO $pdo,$string,$easyload=true)
	{
		...
		new MandateBornageTerrain($pdo,$array['idMandateBornageTerrain'],$array['name'],$array['code'],$easyload);
	}
