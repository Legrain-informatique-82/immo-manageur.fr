...
foreach (glob( Constant::DEFAULT_PICTURE_MODULE_DIRECTORY.'mandat/big/*') as $file) {
	$total = explode('/',$file);
		$nbMax = count($total);
		$img_Src = '';
		$rep_Src = '';
	...
	fctredimimage(Constant::SIZE_X_PICTURE, Constant::SIZE_Y_PICTURE, Constant::DEFAULT_PICTURE_MODULE_DIRECTORY . 'mandat/', $img_Dst, $rep_Src, $img_Src);
	fctredimimage(Constant::SIZE_THUMB_X_PICTURE, Constant::SIZE_THUMB_Y_PICTURE, Constant::DEFAULT_PICTURE_MODULE_DIRECTORY . 'mandat/thumb/', $img_Dst, $rep_Src, $img_Src);
}

foreach (glob( Constant::DEFAULT_PICTURE_MODULE_DIRECTORY.'terrain/big/*') as $file) {
$total = explode('/',$file);
		$nbMax = count($total);
		$img_Src = '';
		$rep_Src = '';
		...
		$img_Dst = $img_Src;
	fctredimimage(Constant::SIZE_X_PICTURE, Constant::SIZE_Y_PICTURE, Constant::DEFAULT_PICTURE_MODULE_DIRECTORY . 'terrain/', $img_Dst, $rep_Src, $img_Src);
	fctredimimage(Constant::SIZE_THUMB_X_PICTURE, Constant::SIZE_THUMB_Y_PICTURE, Constant::DEFAULT_PICTURE_MODULE_DIRECTORY . 'terrain/thumb/', $img_Dst, $rep_Src, $img_Src);
}


// redimentionne les images à partir de big
