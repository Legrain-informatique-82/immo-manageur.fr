...
class City
{
	...
	public static function create(PDO $pdo,$name,$zipCode,$numberUsed,Sector $sector,$easyload=true)
	{
		...
		$sector->setNumberUsed(($sector->getNumberUsed()+1),true);
	...
	public static function loadAll(PDO $pdo,$easyload=false)
	{
		...
		$pdoStatement = City::selectAll($pdo,'c.zipCode');
	...
	{
		$pdoStatement = City::_select($pdo,null,$order);
	...
	public static function count(PDO $pdo,$where = '' )
	{
		...
		$sql = 'SELECT COUNT(idCity) FROM City '.$where;
		//		echo $sql;
	...
	{
		$this->getSector()->setNumberUsed($this->getSector()->getNumberUsed() -1 ,true);
		// Supprimer le/la city
