...
class Mandate
{
	...
	/// @var int
	private $superficieNonConstructible;
	...
	private $nature;
	private $estimationMaxi;
	private $pubInternet;
	private $notaryAcq;
	private $typeTerrain;
	private $situationTerrain;
	private $mandateAdjoining ;
	
	private $rental;
	private $numberGarage;
	private $numberCellar;
	private $numberParking;
	private $numberAttic;
	private $priceGarage;
	private $priceCellar;
	 ...
	 * @param $superficieNonConstructible int
	 ...
	 * @param $cuValide bool
	 * @param $dateCU int
	 * @param $prorogationCUJusquau int
	 * @param $cuOPSValide bool
	 * @param $dateCuOPS int
	 * @param $prorogationCuOPSJusquau int
	 ...
	 * @param $nature de de MandateNature
	 * 
	 * @param $easyload bool activer le chargement rapide ?
	 * @return Mandate
	 */
	protected function __construct(PDO $pdo,$idMandate,$numberMandate,$initDate,$deadDate,$address,$priceFai,$priceSeller,$commission,$estimationFai,$margeNegociation,
	$referenceCadastreParcelle1,$referenceCadastreParcelle2,$referenceCadastreParcelle3,$autreReferenceParcelle,$superficieParcelle1,$superficieParcelle2,
	$superficieParcelle3,$superficieAutreParcelle,$superficieConstructible,$superficieNonConstructible,$superficieTotale,$numberLot,$sHONAccordee,$reglementDeLotissement,
	$eRNT,$passageEau,$passageElectricite,$passageGaz,$voirie,$tailleFacade,$profondeurTerrain,$commentaire,$geolocalisation,$proximiteEcole,$proximiteCommerce,
	$proximiteTransport,$commentaireApparent,$nbPiece,$surfaceHabitable,$nbChambre,$surfacePieceVie,$niveau,$anneeConstruction,$chargesMensuelle,$taxesFonciere,
	$taxeHabitation,$user,$sector,$city,$notary,$mandateType,$transactionType,$etap,$freeDate=null,$zoneBDF=false,$ligneDeCrete=false,$zoneInondable=false,
	$dPValide=false,$dateDeclarationPrealable=null,$prorogationDPJusquau=null,$cuValide=false,$dateCU=null,$prorogationCUJusquau=null,$cuOPSValide=false,
	$dateCuOPS=null,$prorogationCuOPSJusquau=null,$permisDamenagerValide=false,$datePermisDamenager=null,$terrainVenduViabilise=false,$terrainVenduSemiViabilise=false,
	$terrainVenduNonViabilise=false,$toutALegout=false,$assainissementParFosseSceptique=false,$coupCoeur=false,$nouveaute=null,$cheminee=false,$cuisineEquipee=false,
	$cuisineAmenagee=false,$piscine=false,$poolHouse=false,$terrasse=false,$mezzanine=false,$dependance=false,$gaz=false,$cave=false,$sousSol=false,$garage=false,$parking=false,
	$rezDeJardin=false,$plainPied=false,$carriere=false,$pointEau=false,$slope=null,$orientation=null,$insulation=null,$news=null,$heating=null,$commonOwnership=null,$roof=null,
	$condition=null,$style=null,$construction=null,$sanitationCorresponding=null,$electricCorresponding=null,$gazCorresponding=null,$waterCorresponding=null,$cos=null,
	$zonagePLU=null,$zonageRNU=null,$bornageTerrain=null,$geometer=null,$nature=null,$estimationMaxi = null,$pubInternet=null,$notaryAcq = null,$typeTerrain=null,
	$situationTerrain=null,$mandateAdjoining = null,
     $rental= null,
	 $numberGarage= null,
	 $numberCellar= null,
	 $numberParking= null,
	...
	$easyload=false)
	{
		...
		$this->superficieNonConstructible = $superficieNonConstructible;
		...
		$this->nature = $nature;
		$this->estimationMaxi = $estimationMaxi;
		$this->pubInternet = $pubInternet;
		$this->notaryAcq = $notaryAcq;
		$this->typeTerrain = $typeTerrain;
		$this->situationTerrain = $situationTerrain;
		$this->mandateAdjoining = $mandateAdjoining;
		$this->rental= $rental;
		$this->numberGarage= $numberGarage;
		$this->numberCellar= $numberCellar;
		$this->numberParking= $numberParking;
		$this->numberAttic= $numberAttic;
		$this->priceGarage= $priceGarage;
		$this->priceCellar= $priceCellar;
	...
	//			var_dump($values);
		...
		$sql = 'UPDATE Mandate SET '.implode(', ', $updates).' WHERE idMandate = ?';
		//echo $sql;
		//var_dump($values);
	...
	$a = array('numberMandate','initDate','deadDate','freeDate','address','priceFai','priceSeller','commission','estimationFai','margeNegociation','referenceCadastreParcelle1','referenceCadastreParcelle2','referenceCadastreParcelle3','autreReferenceParcelle','superficieParcelle1','superficieParcelle2','superficieParcelle3','superficieAutreParcelle','superficieConstructible','superficieNonConstructible','superficieTotale','numberLot','sHONAccordee','zoneBDF','ligneDeCrete','zoneInondable','reglementDeLotissement','eRNT','dPValide','dateDeclarationPrealable','prorogationDPJusquau','cuValide','dateCU','prorogationCUJusquau','cuOPSValide','dateCuOPS','prorogationCuOPSJusquau','permisDamenagerValide','datePermisDamenager','terrainVenduViabilise','terrainVenduSemiViabilise','terrainVenduNonViabilise','passageEau','passageElectricite','passageGaz','toutALegout','assainissementParFosseSceptique','voirie','tailleFacade','profondeurTerrain','commentaire','geolocalisation','proximiteEcole','proximiteCommerce','proximiteTransport','commentaireApparent','nbPiece','surfaceHabitable','nbChambre','surfacePieceVie','niveau','anneeConstruction','coupCoeur','chargesMensuelle','taxesFonciere','taxeHabitation','nouveaute','cheminee','cuisineEquipee','cuisineAmenagee','piscine','poolHouse','terrasse','mezzanine','dependance','gaz','cave','sousSol','garage','parking','rezDeJardin','plainPied','carriere','pointEau','user_idUser','sector_idSector','city_idCity','notary_idNotary','mandateType_idMandateType','transactionType_idTransactionType','slope_idMandateSlope','orientation_idMandateOrientation','insulation_idMandateInsulation','news_idMandateNews','heating_idMandateHeating','commonOwnership_idMandateCommonOwnership','roof_idMandateRoof','condition_idMandateCondition','style_idMandateStyle','construction_idMandateConstructionType','sanitationCorresponding_idMandateSanitationCorresponding','electricCorresponding_idMandateElectricCorresponding','gazCorresponding_idMandateGazCorresponding','waterCorresponding_idMandateWaterCorresponding','cos_idMandateCOS','zonagePLU_idMandateZonagePLU','zonageRNU_idMandateZonageRNU','bornageTerrain_idMandateBornageTerrain','geometer_idMandateGeometer','etap_idMandateEtap','nature_idMandateNature','estimationMaxi','pubInternet','notary_idNotary_acq','typeTerrain','situationTerrain','MandateAdjoining_idMandateAdjoining','rental','numbergarage','numbercellar','numberparking','numberattic','pricegarage','pricecellar','profitability');
	$b = array($this->numberMandate,date('Y-m-d',$this->initDate),date('Y-m-d',$this->deadDate),$this->freeDate === null||$this->freeDate === false ? null : date('Y-m-d',$this->freeDate),$this->address,$this->priceFai,$this->priceSeller,$this->commission,$this->estimationFai,$this->margeNegociation,$this->referenceCadastreParcelle1,$this->referenceCadastreParcelle2,$this->referenceCadastreParcelle3,$this->autreReferenceParcelle,$this->superficieParcelle1,$this->superficieParcelle2,$this->superficieParcelle3,$this->superficieAutreParcelle,$this->superficieConstructible,$this->superficieNonConstructible,$this->superficieTotale,$this->numberLot,$this->sHONAccordee,$this->zoneBDF,$this->ligneDeCrete,$this->zoneInondable,$this->reglementDeLotissement,$this->eRNT,$this->dPValide,$this->dateDeclarationPrealable === null ? null : date('Y-m-d',$this->dateDeclarationPrealable),$this->prorogationDPJusquau === null ? null : date('Y-m-d',$this->prorogationDPJusquau),$this->cuValide,$this->dateCU === null ? null : date('Y-m-d',$this->dateCU),$this->prorogationCUJusquau === null ? null : date('Y-m-d',$this->prorogationCUJusquau),$this->cuOPSValide,$this->dateCuOPS === null ? null : date('Y-m-d',$this->dateCuOPS),$this->prorogationCuOPSJusquau === null ? null : date('Y-m-d',$this->prorogationCuOPSJusquau),$this->permisDamenagerValide,$this->datePermisDamenager === null ? null : date('Y-m-d',$this->datePermisDamenager),$this->terrainVenduViabilise,$this->terrainVenduSemiViabilise,$this->terrainVenduNonViabilise,$this->passageEau,$this->passageElectricite,$this->passageGaz,$this->toutALegout,$this->assainissementParFosseSceptique,$this->voirie,$this->tailleFacade,$this->profondeurTerrain,$this->commentaire,$this->geolocalisation,$this->proximiteEcole,$this->proximiteCommerce,$this->proximiteTransport,$this->commentaireApparent,$this->nbPiece,$this->surfaceHabitable,$this->nbChambre,$this->surfacePieceVie,$this->niveau,$this->anneeConstruction,$this->coupCoeur,$this->chargesMensuelle,$this->taxesFonciere,$this->taxeHabitation,$this->nouveaute === null ? null : date('Y-m-d',$this->nouveaute),$this->cheminee,$this->cuisineEquipee,$this->cuisineAmenagee,$this->piscine,$this->poolHouse,$this->terrasse,$this->mezzanine,$this->dependance,$this->gaz,$this->cave,$this->sousSol,$this->garage,$this->parking,$this->rezDeJardin,$this->plainPied,$this->carriere,$this->pointEau,$this->user,$this->sector,$this->city,$this->notary,$this->mandateType,$this->transactionType,$this->slope,$this->orientation,$this->insulation,$this->news,$this->heating,$this->commonOwnership,$this->roof,$this->condition,$this->style,$this->construction,$this->sanitationCorresponding,$this->electricCorresponding,$this->gazCorresponding,$this->waterCorresponding,$this->cos,$this->zonagePLU,$this->zonageRNU,$this->bornageTerrain,$this->geometer,$this->etap,$this->nature,$this->estimationMaxi,$this->pubInternet,$this->notaryAcq,$this->typeTerrain,$this->situationTerrain,$this->mandateAdjoining,$this->rental,$this->numberGarage,$this->numberCellar,$this->numberParking,$this->numberAttic,$this->priceGarage,$this->priceCellar,$this->profitability);
	//var_dump($a);	
	//var_dump($b);		
		return $this->_set(
		$a,
	...
	/**
	 * R�cup�rer le/la superficieNonConstructible
	 * @return int
	 */
	public function getSuperficieNonConstructible()
	{
		return $this->superficieNonConstructible;
	}

	/**
	 * D�finir le/la superficieNonConstructible
	 * @param $superficieNonConstructible int
	 * @param $execute bool ex�cuter la requ�te update ?
	 * @return bool op�ration r�ussie ?
	 */
	public function setSuperficieNonConstructible($superficieNonConstructible,$execute=true)
	{
		// Sauvegarder dans l'objet
		$this->superficieNonConstructible = $superficieNonConstructible;

		// Sauvegarder dans la base de donn�es (ou pas)
		return $execute ? $this->_set(array('superficieNonConstructible'),array($superficieNonConstructible)) : true;
	}
	 ...
	 * @return bool op�ration r�ussie ?
	 */
	public function setDateCU($dateCU=null,$execute=true)
	{
		// Sauvegarder dans l'objet
		$this->dateCU = $dateCU;

		// Sauvegarder dans la base de donn�es (ou pas)
		return $execute ? $this->_set(array('dateCU'),array($dateCU === null ? null : date('Y-m-d',$dateCU))) : true;
	}
	 ...
	 * @return bool op�ration r�ussie ?
	 */
	public function setProrogationCUJusquau($prorogationCUJusquau=null,$execute=true)
	{
		// Sauvegarder dans l'objet
		$this->prorogationCUJusquau = $prorogationCUJusquau;

		// Sauvegarder dans la base de donn�es (ou pas)
		return $execute ? $this->_set(array('prorogationCUJusquau'),array($prorogationCUJusquau === null ? null : date('Y-m-d',$prorogationCUJusquau))) : true;
	}
	 ...
	 * @return bool op�ration r�ussie ?
	 */
	public function setProrogationCuOPSJusquau($prorogationCuOPSJusquau=null,$execute=true)
	{
		// Sauvegarder dans l'objet
		$this->prorogationCuOPSJusquau = $prorogationCuOPSJusquau;

		// Sauvegarder dans la base de donn�es (ou pas)
		return $execute ? $this->_set(array('prorogationCuOPSJusquau'),array($prorogationCuOPSJusquau === null ? null : date('Y-m-d',$prorogationCuOPSJusquau))) : true;
	}
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain,m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability   FROM Mandate m WHERE m.sector_idSector = ?');
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain,m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability   FROM Mandate m WHERE m.city_idCity = ?');
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain,m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability   FROM Mandate m WHERE m.notary_idNotary = ?');
	 ...
	 * @return Notary
	 */
	public function getNotaryAcq()
	{
		return Notary::load($this->pdo,$this->notaryAcq);
	}
	 ...
	 * @return bool op�ration r�ussie ?
	 */
	public function setNotaryAcq( $notary=null,$execute=true)
	{
		// Sauvegarder dans l'objet
		$this->notaryAcq =$notary==null?null: $notary->getIdNotary();

		// Sauvegarder dans la base de donn�es (ou pas)
		return $execute ? $this->_set(array('notary_idNotary_acq'),array($notary==null?null:$notary->getIdNotary() )) : true;
	}
	 ...
	 * @return PDOStatement
	 */
	public static function selectByNotaryAcq(PDO $pdo,Notary $notary)
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain,m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability  FROM Mandate m WHERE m.notary_idNotary_acq = ?');
		if (!$pdoStatement->execute(array($notary->getIdNotary()))) {
			throw new Exception('Erreur lors du chargement de tous/toutes les mandates par notary depuis la base de donn�es');
		}
		return $pdoStatement;
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain,m.situationTerrain,m.MandateAdjoining_idMandateAdjoining ,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability  FROM Mandate m WHERE m.mandateType_idMandateType = ?');
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain,m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability   FROM Mandate m WHERE m.transactionType_idTransactionType = ?');
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain,m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability   FROM Mandate m WHERE m.slope_idMandateSlope = ?');
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain,m.situationTerrain,m.MandateAdjoining_idMandateAdjoining ,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability  FROM Mandate m WHERE m.orientation_idMandateOrientation = ?');
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain,m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability   FROM Mandate m WHERE m.insulation_idMandateInsulation = ?');
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain,m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability   FROM Mandate m WHERE m.news_idMandateNews = ?');
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain,m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability   FROM Mandate m WHERE m.heating_idMandateHeating = ?');
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain,m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability   FROM Mandate m WHERE m.commonOwnership_idMandateCommonOwnership = ?');
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain,m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability   FROM Mandate m WHERE m.roof_idMandateRoof = ?');
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain,m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability   FROM Mandate m WHERE m.condition_idMandateCondition = ?');
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain,m.situationTerrain ,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability  FROM Mandate m WHERE m.style_idMandateStyle = ?');
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain, m.situationTerrain,m.MandateAdjoining_idMandateAdjoining ,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability  FROM Mandate m WHERE m.construction_idMandateConstructionType = ?');
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain, m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability   FROM Mandate m WHERE m.sanitationCorresponding_idMandateSanitationCorresponding = ?');
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain, m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability   FROM Mandate m WHERE m.electricCorresponding_idMandateElectricCorresponding = ?');
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain, m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability   FROM Mandate m WHERE m.gazCorresponding_idMandateGazCorresponding = ?');
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain, m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability   FROM Mandate m WHERE m.waterCorresponding_idMandateWaterCorresponding = ?');
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain, m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability   FROM Mandate m WHERE m.cos_idMandateCOS = ?');
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain, m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability   FROM Mandate m WHERE m.zonagePLU_idMandateZonagePLU = ?');
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain, m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability   FROM Mandate m WHERE m.zonageRNU_idMandateZonageRNU = ?');
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain, m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability   FROM Mandate m WHERE m.bornageTerrain_idMandateBornageTerrain = ?');
	...
	/**
	 * S�lectionner les mandates par nature
	 * @param $pdo PDO
	 * @param $nature MandateNature
	 * @return PDOStatement
	 */
	public static function selectByNature(PDO $pdo,MandateNature  $nature)
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain, m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability   FROM Mandate m WHERE m.nature_idMandateNature = ?');
		if (!$pdoStatement->execute(array($nature->getIdMandateNature()))) {
	...
	/**
	 * R�cup�rer le/la nature
	 * @return Mandatenature
	 */
	public function getNature()
	{
		// Retourner null si n�c�ssaire
		if ($this->nature == null) { return null; }

		// Charger et retourner mandateGeometer
		return MandateNature::load($this->pdo,$this->nature);
	}

	/**
	 * D�finir le/la nature
	 * @param $nature MandateNature
	 * @param $execute bool ex�cuter la requ�te update ?
	 * @return bool op�ration r�ussie ?
	 */
	public function setNature($nature=null,$execute=true)
	{
		// Sauvegarder dans l'objet
		$this->nature = $nature == null ? null : $nature->getIdMandateNature();

		// Sauvegarder dans la base de donn�es (ou pas)
		return $execute ? $this->_set(array('nature_idMandateNature'),array($nature == null ? null : $nature->getIdMandateNature())) : true;
	}
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain, m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability   FROM Mandate m WHERE m.geometer_idMandateGeometer = ?');
	...
	/**
	 * R�cup�rer le/la estimation Maxi
	 * @return string
	 */
	public function getEstimationMaxi()
	{
		return $this->estimationMaxi;
	}

	/**
	 * D�finir le/la pub maxi
	 * @param $estimationMaxi string
	 * @param $execute bool ex�cuter la requ�te update ?
	 * @return bool op�ration r�ussie ?
	 */
	public function setEstimationMaxi($estimationMaxi,$execute=true)
	{
		// Sauvegarder dans l'objet
		$this->estimationMaxi = $estimationMaxi;

		// Sauvegarder dans la base de donn�es (ou pas)
		return $execute ? $this->_set(array('estimationMaxi'),array($estimationMaxi)) : true;
	}

	/**
	 * R�cup�rer le/la pubInternet
	 * @return string
	 */
	public function getPubInternet()
	{
		return $this->pubInternet;
	}

	/**
	 * D�finir le/la pubInternet
	 * @param $pubInternet string
	 * @param $execute bool ex�cuter la requ�te update ?
	 * @return bool op�ration r�ussie ?
	 */
	public function setPubInternet($pubInternet,$execute=true)
	{
		// Sauvegarder dans l'objet
		$this->pubInternet = $pubInternet;

		// Sauvegarder dans la base de donn�es (ou pas)
		return $execute ? $this->_set(array('pubInternet'),array($pubInternet)) : true;
	}

	
	/**
	* R�cup�rer le/la typeTerrain
	* @return string
	*/
	...
	/**
	 * D�finir le/la typeTerrain
	 * @param $pubInternet string
	 * @param $execute bool ex�cuter la requ�te update ?
	 * @return bool op�ration r�ussie ?
	 */
	public function setTypeTerrain($typeTerrain,$execute=true)
	{
		// Sauvegarder dans l'objet
		$this->typeTerrain = $typeTerrain;
	
		// Sauvegarder dans la base de donn�es (ou pas)
		return $execute ? $this->_set(array('typeTerrain'),array($typeTerrain)) : true;
	}
	
	
	/**
	* R�cup�rer le/la situationTerrain
	* @return string
	*/
	public function getSituationTerrain()
	{
		return $this->situationTerrain;
	}
	
	/**
	 * D�finir le/la situationTerrain
	 * @param $situationTerrain string
	 * @param $execute bool ex�cuter la requ�te update ?
	 * @return bool op�ration r�ussie ?
	 */
	public function setSituationTerrain($situationTerrain,$execute=true)
	{
		// Sauvegarder dans l'objet
		$this->situationTerrain = $situationTerrain;
	
		// Sauvegarder dans la base de donn�es (ou pas)
		return $execute ? $this->_set(array('situationTerrain'),array($situationTerrain)) : true;
	}
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain, m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability   FROM Mandate m WHERE m.etap_idMandateEtap = ?');
	...
	public function getDefaultSeller(){
		$pdoStatement = $this->pdo->prepare("Select s.idSeller, s.name, s.firstname, s.address, s.phone, s.mobilPhone, s.workPhone, s.fax, s.email, s.comments,s.numberUsed, s.city_idCity, s.sellerTitle_idSellerTitle, s.user_idUser, s.asset  from Mandate_Seller ms, Seller s WHERE (ms.fk_idSeller = s.idSeller) AND ms.fk_idMandate = ? AND ms.isDefault = 1");
		if (!$pdoStatement->execute(array($this->getIdMandate() ) )) {
			throw new Exception('Erreur lors du chargement de tous/toutes les mandates par etap depuis la base de donn�es');
		}
	...
	public function listSellers(){
		$pdoStatement = $this->pdo->prepare("Select s.idSeller, s.name, s.firstname, s.address, s.phone, s.mobilPhone, s.workPhone, s.fax, s.email, s.comments,s.numberUsed, s.city_idCity, s.sellerTitle_idSellerTitle, s.user_idUser, s.asset,ms.isDefault  from Mandate_Seller ms, Seller s WHERE (ms.fk_idSeller = s.idSeller) AND ms.fk_idMandate = ?");
		if (!$pdoStatement->execute(array($this->getIdMandate() ) )) {
			throw new Exception('Erreur lors du chargement de tous/toutes les mandates par etap depuis la base de donn�es');
		}
		//		return $pdoStatement;
	...
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible,m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer, m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain,m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability  FROM Mandate m WHERE m.etap_idMandateEtap = ? AND m.mandateType_idMandateType = ?');
	...
	public static function selectByEtapAndOtherType(PDO $pdo,MandateEtap $etap,MandateType $type)
	{
		if (!$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible,m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain, m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability  FROM Mandate m WHERE m.etap_idMandateEtap = ? AND m.mandateType_idMandateType != ?')){
	...
	public function listPlan(){
		$pdoStatement = $this->pdo->prepare('SELECT s.idMandateScan ,s.name,s.code ,s.fk_idMandate FROM MandateScan s WHERE s.fk_idMandate = ?');
		if (!$pdoStatement->execute(array( $this->idMandate ))){
			throw new Exception('Erreur lors du chargement de tous/toutes les mandates par etap depuis la base de donn�es');
		}
		$return = array();
		while ($r = MandateScan::fetch($this->pdo,$pdoStatement))
		$return[]=$r;
		return $return;
	}
	public function listMandateBySeller(PDO $pdo,Seller $seller ){
		$sql = 'SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer, m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain, m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability 
		 FROM Mandate m , Mandate_Seller ms
		 WHERE (m.idMandate = ms.fk_idMandate)  
		 AND ms.fk_idSeller = ?';
		$pdoStatement = $pdo->prepare($sql);
		if (!$pdoStatement->execute(array( $seller->getIdSeller() ))){
			throw new Exception('Erreur lors du chargement de tous/toutes les mandates par seller depuis la base de donn�es');
		}
		$return = array();
		while ($r = Mandate::fetch($pdo,$pdoStatement))
		$return[]=$r;
		return $return;
	}

	/**
	 * S�lectionner les mandates par vendeur
	 * @param $pdo PDO
	 * @param $seller Seller
	 * @param $mandateExplu
	 * @return PDOStatement
	 */
	public static function countMandateBySeller(PDO $pdo,Fk_seller $seller,$arrayIdMandateExlu =array() )
	{
		$sql = 'SELECT count(m.idMandate)
		FROM Mandate m , Mandate_Seller ms
		WHERE  (m.idMandate = ms.fk_idMandate )
		AND ms.fk_idSeller = ?';
		$array = array($seller->getIdSeller());

		if(!empty($arrayIdMandateExlu)){

			foreach($arrayIdMandateExlu as $a){
				$sql.=' AND m.idMandate != ? ';
				$array[] = $a;
			}
		}
		...
		if (!$pdoStatement->execute($array )) {
			throw new Exception('Erreur lors du chargement de tous/toutes les mandates pour le vendeur');
		}
		$count =$pdoStatement->fetch();
		return (int)$count['count(m.idMandate)'];
	}

	public static function loadByEtap(PDO $pdo,MandateEtap $etap){
		$pdoStatement = Mandate::selectByEtap($pdo,$etap);
	 ...
	 * @param $pdo PDO
	 * @param $mandate Mandate
	 * @param $next Bool si next est à un on choisis la ligne suivante. La ligne précédente le cas écheant
	 * @param
	 * @param $easyload bool activer le chargement rapide ?
	 * @return Mandate
	 */
	public static function loadPreviewOrNext(PDO $pdo,Mandate $mandate,$next = true,$terrain = false,$easyload=true)
	{
		$desc= $next?'ASC':'DESC';
		$next = $next?'>':'<';
		...
		$sql =
		'SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer, m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain, m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability  
		FROM Mandate m 
		WHERE m.idMandate '.$next.' ? 
		AND m.mandateType_idMandateType  '.$terrain.' ? 
		AND m.etap_idMandateEtap = ? 
		ORDER BY m.idMAndate '.$desc.' 
		LIMIT 0,1';
		// Charger le/la mandate

		$pdoStatement = $pdo->prepare($sql);
		if (!$pdoStatement->execute(array($mandate->getIdMandate(),Constant::ID_PLOT_OF_LAND,$mandate->getEtap()->getIdMandateEtap() ))) {
			throw new Exception('Erreur lors du chargement d\'un(e) mandate depuis la base de donn�es');
		}
		// R�cup�rer le/la mandate depuis le jeu de r�sultats
		return Mandate::fetch($pdo,$pdoStatement,$easyload);
	...
	public static function loadFirstOrLast(PDO $pdo,Mandate $mandate,$next = true,$terrain = false,$easyload=true)
	{
		$desc= $next?'DESC':'ASC';
		$next = $next?'>':'<';
	...
	public static function selectByNumberMandate(PDO $pdo,$numberMandate)
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain,m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability   FROM Mandate m WHERE m.numberMandate = ?');
		if (!$pdoStatement->execute(array($numberMandate) )) {
			throw new Exception('Erreur lors du chargement de tous/toutes les mandates par news depuis la base de donn�es');
		}
		return $pdoStatement;
	}
	...
	/**
	* R�cup�rer le/la MandateAdjoining
	* @return MandateAdjoining
	*/
	public function getMandateAdjoining()
	{
		
		
		// Retourner null si n�c�ssaire
		if ($this->mandateAdjoining == null) {
			return null;
		}
		
		// Charger et retourner mandateGeometer
		return MandateAdjoining::load($this->pdo,$this->mandateAdjoining);
		
	}
	
	/**
	 * D�finir le/la MandateAdjoining
	 * @param $mandateAdjoining MandateAdjoining
	 * @param $execute bool ex�cuter la requ�te update ?
	 * @return bool op�ration r�ussie ?
	 */
	public function setMandateAdjoining(MandateAdjoining $mandateAdjoining=null,$execute=true)
	{
		// Sauvegarder dans l'objet
		$this->mandateAdjoining = $mandateAdjoining==null?null:$mandateAdjoining->getId();
	
		// Sauvegarder dans la base de donn�es (ou pas)
		return $execute ? $this->_set(array('MandateAdjoining_idMandateAdjoining'),array($mandateAdjoining==null?null:$mandateAdjoining->getId())) : true;
		
	}
	
	
	/**
	* R�cup�rer le/la $rental
	* @return float
	*/
	...
	/**
	 * D�finir le/la rental
	 * @param $rental float
	 * @param $execute bool ex�cuter la requ�te update ?
	 * @return bool op�ration r�ussie ?
	 */
	public function setRental($rental,$execute=true)
	{
		// Sauvegarder dans l'objet
		$this->rental = $rental;
	
		// Sauvegarder dans la base de donn�es (ou pas)
		return $execute ? $this->_set(array('rental'),array($rental)) : true;
	}
	/**
	* R�cup�rer le/la numberGarage
	* @return String
	*/
	public function getNumberGarage()
	{
		return $this->numberGarage;
	}
	
	/**
	 * D�finir le/la numberGarage
	 * @param $numberGarage String
	 * @param $execute bool ex�cuter la requ�te update ?
	 * @return bool op�ration r�ussie ?
	 */
	public function setNumberGarage($numberGarage,$execute=true)
	{
		// Sauvegarder dans l'objet
		$this->numberGarage = $numberGarage;
	
		// Sauvegarder dans la base de donn�es (ou pas)
		return $execute ? $this->_set(array('numbergarage'),array($numberGarage)) : true;
	}
	/**
	* R�cup�rer le/la numberCellar
	* @return string
	*/
	public function getNumberCellar()
	{
		return $this->numberCellar;
	}
	
	/**
	 * D�finir le/la numberCellar
	 * @param $numberCellar string
	 * @param $execute bool ex�cuter la requ�te update ?
	 * @return bool op�ration r�ussie ?
	 */
	public function setNumberCellar($numberCellar,$execute=true)
	{
		// Sauvegarder dans l'objet
		$this->numberCellar = $numberCellar;
	
		// Sauvegarder dans la base de donn�es (ou pas)
		return $execute ? $this->_set(array('numbercellar'),array($numberCellar)) : true;
	}
	/**
	* R�cup�rer le/la numberParking
	* @return string
	*/
	public function getNumberParking()
	{
		return $this->numberParking;
	}
	
	/**
	 * D�finir le/la numberParking
	 * @param $numberParking string
	 * @param $execute bool ex�cuter la requ�te update ?
	 * @return bool op�ration r�ussie ?
	 */
	public function setNumberParking($numberParking,$execute=true)
	{
		// Sauvegarder dans l'objet
		$this->numberParking = $numberParking;
	
		// Sauvegarder dans la base de donn�es (ou pas)
		return $execute ? $this->_set(array('numberparking'),array($numberParking)) : true;
	}
	/**
	* R�cup�rer le/la numberAttic
	* @return string
	*/
	public function getNumberAttic()
	{
		return $this->numberAttic;
	}
	
	/**
	 * D�finir le/la numberAttic
	 * @param $numberAttic string
	 * @param $execute bool ex�cuter la requ�te update ?
	 * @return bool op�ration r�ussie ?
	 */
	public function setNumberAttic($numberAttic,$execute=true)
	{
		// Sauvegarder dans l'objet
		$this->numberAttic = $numberAttic;
	
		// Sauvegarder dans la base de donn�es (ou pas)
		return $execute ? $this->_set(array('numberattic'),array($numberAttic)) : true;
	}
	/**
	* R�cup�rer le/la priceGarage
	* @return Float
	*/
	public function getPriceGarage()
	{
		return $this->priceGarage;
	}
	
	/**
	 * D�finir le/la priceGarage
	 * @param $priceGarage float
	 * @param $execute bool ex�cuter la requ�te update ?
	 * @return bool op�ration r�ussie ?
	 */
	public function setPriceGarage($priceGarage,$execute=true)
	{
		// Sauvegarder dans l'objet
		$this->priceGarage = $priceGarage;
	
		// Sauvegarder dans la base de donn�es (ou pas)
		return $execute ? $this->_set(array('pricegarage'),array($priceGarage)) : true;
	}
	/**
	* R�cup�rer le/la priceCellar
	* @return Float
	*/
	public function getPriceCellar()
	{
		return $this->priceCellar;
	}
	
	/**
	 * D�finir le/la priceCellar
	 * @param $priceCellar float
	 * @param $execute bool ex�cuter la requ�te update ?
	 * @return bool op�ration r�ussie ?
	 */
	public function setPriceCellar($priceCellar,$execute=true)
	{
		// Sauvegarder dans l'objet
		$this->priceCellar = $priceCellar;
	
		// Sauvegarder dans la base de donn�es (ou pas)
		return $execute ? $this->_set(array('pricecellar'),array($priceCellar)) : true;
	}
	/**
	* R�cup�rer le/la profitability
	* @return string
	*/
	...
	/**
	 * D�finir le/la profitability
	 * @param $profitability string
	 * @param $execute bool ex�cuter la requ�te update ?
	 * @return bool op�ration r�ussie ?
	 */
	public function setProfitability($profitability,$execute=true)
	{
		// Sauvegarder dans l'objet
		$this->profitability = $profitability;
	
		// Sauvegarder dans la base de donn�es (ou pas)
		return $execute ? $this->_set(array('profitability'),array($profitability)) : true;
	}
	 ...
	 * @return PDOStatement
	 */
	public static function selectByMandateAdjoining(PDO $pdo,MandateAdjoining $mandateAdjoining)
	{
		$pdoStatement = $pdo->prepare('SELECT m.idMandate, m.numberMandate, m.initDate, m.deadDate, m.address, m.priceFai, m.priceSeller, m.commission, m.estimationFai, m.margeNegociation, m.referenceCadastreParcelle1, m.referenceCadastreParcelle2, m.referenceCadastreParcelle3, m.autreReferenceParcelle, m.superficieParcelle1, m.superficieParcelle2, m.superficieParcelle3, m.superficieAutreParcelle, m.superficieConstructible, m.superficieNonConstructible, m.superficieTotale, m.numberLot, m.sHONAccordee, m.reglementDeLotissement, m.eRNT, m.passageEau, m.passageElectricite, m.passageGaz, m.voirie, m.tailleFacade, m.profondeurTerrain, m.commentaire, m.geolocalisation, m.proximiteEcole, m.proximiteCommerce, m.proximiteTransport, m.commentaireApparent, m.nbPiece, m.surfaceHabitable, m.nbChambre, m.surfacePieceVie, m.niveau, m.anneeConstruction, m.chargesMensuelle, m.taxesFonciere, m.taxeHabitation, m.user_idUser, m.sector_idSector, m.city_idCity, m.notary_idNotary, m.mandateType_idMandateType, m.transactionType_idTransactionType, m.etap_idMandateEtap, m.freeDate, m.zoneBDF, m.ligneDeCrete, m.zoneInondable, m.dPValide, m.dateDeclarationPrealable, m.prorogationDPJusquau, m.cuValide, m.dateCU, m.prorogationCUJusquau, m.cuOPSValide, m.dateCuOPS, m.prorogationCuOPSJusquau, m.permisDamenagerValide, m.datePermisDamenager, m.terrainVenduViabilise, m.terrainVenduSemiViabilise, m.terrainVenduNonViabilise, m.toutALegout, m.assainissementParFosseSceptique, m.coupCoeur, m.nouveaute, m.cheminee, m.cuisineEquipee, m.cuisineAmenagee, m.piscine, m.poolHouse, m.terrasse, m.mezzanine, m.dependance, m.gaz, m.cave, m.sousSol, m.garage, m.parking, m.rezDeJardin, m.plainPied, m.carriere, m.pointEau, m.slope_idMandateSlope, m.orientation_idMandateOrientation, m.insulation_idMandateInsulation, m.news_idMandateNews, m.heating_idMandateHeating, m.commonOwnership_idMandateCommonOwnership, m.roof_idMandateRoof, m.condition_idMandateCondition, m.style_idMandateStyle, m.construction_idMandateConstructionType, m.sanitationCorresponding_idMandateSanitationCorresponding, m.electricCorresponding_idMandateElectricCorresponding, m.gazCorresponding_idMandateGazCorresponding, m.waterCorresponding_idMandateWaterCorresponding, m.cos_idMandateCOS, m.zonagePLU_idMandateZonagePLU, m.zonageRNU_idMandateZonageRNU, m.bornageTerrain_idMandateBornageTerrain, m.geometer_idMandateGeometer,m.nature_idMandateNature,m.estimationMaxi,m.pubInternet,m.notary_idNotary_acq,m.typeTerrain,m.situationTerrain,m.MandateAdjoining_idMandateAdjoining,m.rental,m.numbergarage,m.numbercellar,m.numberparking,m.numberattic,m.pricegarage,m.pricecellar,m.profitability  FROM Mandate m WHERE m.MandateAdjoining_idMandateAdjoining = ?');
		if (!$pdoStatement->execute(array($mandateAdjoining->getId()))) {
			throw new Exception('Erreur lors du chargement de tous/toutes les mandates par user depuis la base de donn�es');
		}
		return $pdoStatement;
	}
