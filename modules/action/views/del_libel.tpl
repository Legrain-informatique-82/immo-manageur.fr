    ...
    <div class="row bg-success bannerTitle">
        ...
        <div class="col-md-6">
            <p class="h4 text-right ">
                <button type="submit" class="btn btn-danger" name="delete" value="{Lang::LABEL_DELETE}">
...
<p class="help-block">Êtes-vous sûr de vouloir supprimer le libellé : {$libel->getLibel()}</p>

	<p>


        <button type="submit" name="delete" value="{Lang::LABEL_DELETE}" class="btn btn-danger">
