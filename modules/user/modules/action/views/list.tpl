		...
		<tbody>
			...
			<tr>
				...
				*}
				...
				<td><a
					href="{Tools::create_url($user,'action','see',$i->getIdAction())}" title="Voir" {if $user->getOpenInNewTab()} target="_blank"{/if}><img src="{Constant::DEFAULT_URL_PICTURE_DIRECTORY}see.png" alt="Voir" /></a>
				</td>
			</tr>
			{/foreach}
		</tbody>
