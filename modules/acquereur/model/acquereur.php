...
class Acquereur
{
	 ...
	 * @param $comment String commentaire
	 * @param $mandateType int id de mandatetype
	 * @param $easyload bool activer le chargement rapide ?
	 * @return Acquereur
	 */
	protected function __construct(PDO $pdo,$idAcquereur,$name,$firstname,$address,$phone,$mobilPhone,$workPhone,$fax,$email,$numberUsed,$priceMin,$priceMax,$surfaceTerrainMin,$surfaceTerrainMax,$surfaceHabitableMin,$surfaceHabitableMax,$villeAcquereur,$titreAcquereur,$transactionType,$user,$comment=null,$mandateStyle = null,$actif=false,$rechercheCity=null,$rechercheSector=null, $mandateType=null,$dateInsert = null,$maidenName = null, $birthdate=null,$birthLocation=null,$nationality=null,$job = null,$easyload=false)
	{
		// Sauvegarder pdo
		$this->pdo = $pdo;
	 ...
	 * @param dateInsert timestamp
	 * @param $easyload bool activer le chargement rapide ?
	 * @return Acquereur
	 */
	public static function create(PDO $pdo,$name,$firstname,$address,$phone,$mobilPhone,$workPhone,$fax,$email,$numberUsed,$priceMin,$priceMax,$surfaceTerrainMin,$surfaceTerrainMax,$surfaceHabitableMin,$surfaceHabitableMax,City $villeAcquereur,TitreAcquereur $titreAcquereur,TransactionType $transactionType,User $user,$comment = null,MandateStyle $mandateStyle=null,$actif=false,$rechercheCity=null,$rechercheSector=null,MandateType $mandateType=null,$dateInsert=null,$maidenName = null, $birthdate=null,$birthLocation=null,$nationality=null,$job = null,$easyload=true)
	{
		...
		user_idUser,comment,mandateStyle_idMandateStyle,actif,rechercheCity_idCity,rechercheSector_idSector,mandateType_idMandateType,dateInsert,maidenName,birthdate,birthLocation,nationality,job)
		 VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,? )');
		// 23 aussi
		...
		$transactionType->getIdTransactionType(),$user->getIdUser(),$comment,$mandateStyle==null?null:$mandateStyle->getIdMandateStyle(), //3
		$actif,$rechercheCity == null ? null : $rechercheCity->getIdCity(),$rechercheSector == null ? null : $rechercheSector->getIdSector(), $mandateType == null ? null : $mandateType->getIdMandateType(), $dateInsert==null?date('Y-m-d H:i:s'):date('Y-m-d H:i:s',$dateInsert) 
		,$maidenName,$birthdate==null?date('Y-m-d H:i:s'):date('Y-m-d H:i:s',$birthdate),$birthLocation,$nationality,$job
		))) { //3
		...
		return new Acquereur($pdo,$pdo->lastInsertId(),$name,$firstname,$address,$phone,$mobilPhone,$workPhone,$fax,$email,$numberUsed,$priceMin,$priceMax,$surfaceTerrainMin,$surfaceTerrainMax,$surfaceHabitableMin,$surfaceHabitableMax,$villeAcquereur->getIdCity(),$titreAcquereur->getIdTitreAcquereur(),$transactionType->getIdTransactionType(),$user->getIdUser(),$comment,$mandateStyle==null?null:$mandateStyle->getIdMandateStyle(),$actif,$rechercheCity==null?null:$rechercheCity->getIdCity(),$rechercheSector==null?null:$rechercheSector->getIdSector(),$mandateType==null?null:$mandateType->getIdMandateType(),$dateInsert,
		$maidenName,$birthdate,$birthLocation,$nationality,$job,
		$easyload);
	}
	...
	{
		return $pdo->prepare('SELECT a.idAcquereur, a.name, a.firstname, a.address, a.phone, a.mobilPhone, a.workPhone, a.fax, a.email, a.numberUsed, a.priceMin, a.priceMax, a.surfaceTerrainMin, a.surfaceTerrainMax, a.surfaceHabitableMin, a.surfaceHabitableMax, a.villeAcquereur, a.titreAcquereur_idTitreAcquereur, a.transactionType_idTransactionType, a.user_idUser,a.comment, a.mandateStyle_idMandateStyle, a.actif, a.rechercheCity_idCity, a.rechercheSector_idSector,a.mandateType_idMandateType,a.dateInsert, a.maidenName,a.birthdate,a.birthLocation,a.nationality,a.job FROM Acquereur a '.
	...
	public static function fetch(PDO $pdo,PDOStatement $pdoStatement,$easyload=false)
	{
		...
		list($idAcquereur,$name,$firstname,$address,$phone,$mobilPhone,$workPhone,$fax,$email,$numberUsed,$priceMin,$priceMax,$surfaceTerrainMin,$surfaceTerrainMax,$surfaceHabitableMin,$surfaceHabitableMax,$villeAcquereur,$titreAcquereur,$transactionType,$user,$comment,$mandateStyle,$actif,$rechercheCity,$rechercheSector,$mandateType,$dateInsert,$maidenName,$birthdate,$birthLocation,$nationality,$job    ) = $values;

		
		// Construire le/la acquereur
		return isset(Acquereur::$easyload[$idAcquereur.'-'.$name.'-'.$firstname.'-'.$address.'-'.$phone.'-'.$mobilPhone.'-'.$workPhone.'-'.$fax.'-'.$email.'-'.$numberUsed.'-'.$priceMin.'-'.$priceMax.'-'.$surfaceTerrainMin.'-'.$surfaceTerrainMax.'-'.$surfaceHabitableMin.'-'.$surfaceHabitableMax.'-'.$villeAcquereur.'-'.$titreAcquereur.'-'.$transactionType.'-'.$user.'-'.$comment.'-'.$mandateStyle.'-'.$actif.'-'.$rechercheCity.'-'.$rechercheSector.'-'.$mandateType.'-'.$dateInsert.'-'.$maidenName.'-'.$birthdate.'-'.$birthLocation.'-'.$nationality.'-'.$job]) ? Acquereur::$easyload[$idAcquereur.'-'.$name.'-'.$firstname.'-'.$address.'-'.$phone.'-'.$mobilPhone.'-'.$workPhone.'-'.$fax.'-'.$email.'-'.$numberUsed.'-'.$priceMin.'-'.$priceMax.'-'.$surfaceTerrainMin.'-'.$surfaceTerrainMax.'-'.$surfaceHabitableMin.'-'.$surfaceHabitableMax.'-'.$villeAcquereur.'-'.$titreAcquereur.'-'.$transactionType.'-'.$user.'-'.$comment.'-'.$mandateStyle.'-'.$actif.'-'.$rechercheCity.'-'.$rechercheSector.'-'.$mandateType.'-'.strtotime($dateInsert).'-'.$maidenName.'-'.strtotime($birthdate).'-'.$birthLocation.'-'.$nationality.'-'.$job] :
		new Acquereur($pdo,$idAcquereur,$name,$firstname,$address,$phone,$mobilPhone,$workPhone,$fax,$email,$numberUsed,$priceMin,$priceMax,$surfaceTerrainMin,$surfaceTerrainMax,$surfaceHabitableMin,$surfaceHabitableMax,$villeAcquereur,$titreAcquereur,$transactionType,$user,$comment,$mandateStyle,$actif,$rechercheCity,$rechercheSector,$mandateType,strtotime($dateInsert),$maidenName,strtotime($birthdate),$birthLocation,$nationality,$job,$easyload);
	}
	...
	{
		$pdoStatement = $pdo->prepare('SELECT a.idAcquereur, a.name, a.firstname, a.address, a.phone, a.mobilPhone, a.workPhone, a.fax, a.email, a.numberUsed, a.priceMin, a.priceMax, a.surfaceTerrainMin, a.surfaceTerrainMax, a.surfaceHabitableMin, a.surfaceHabitableMax, a.villeAcquereur, a.titreAcquereur_idTitreAcquereur, a.transactionType_idTransactionType,a.user_idUser, a.mandateStyle_idMandateStyle, a.actif, a.rechercheCity_idCity, a.rechercheSector_idSector,a.mandateType_idMandateType, a.dateInsert, a.maidenName,a.birthdate,a.birthLocation,a.nationality,a.job FROM Acquereur a WHERE a.titreAcquereur_idTitreAcquereur = ?');
	...
	{
		$pdoStatement = $pdo->prepare('SELECT a.idAcquereur, a.name, a.firstname, a.address, a.phone, a.mobilPhone, a.workPhone, a.fax, a.email, a.numberUsed, a.priceMin, a.priceMax, a.surfaceTerrainMin, a.surfaceTerrainMax, a.surfaceHabitableMin, a.surfaceHabitableMax, a.villeAcquereur, a.titreAcquereur_idTitreAcquereur, a.transactionType_idTransactionType,a.user_idUser, a.mandateStyle_idMandateStyle, a.actif, a.rechercheCity_idCity, a.rechercheSector_idSector,a.mandateType_idMandateType, a.dateInsert, a.maidenName,a.birthdate,a.birthLocation,a.nationality,a.job FROM Acquereur a WHERE a.transactionType_idTransactionType = ?');
	...
	{
		$pdoStatement = $pdo->prepare('SELECT a.idAcquereur, a.name, a.firstname, a.address, a.phone, a.mobilPhone, a.workPhone, a.fax, a.email, a.numberUsed, a.priceMin, a.priceMax, a.surfaceTerrainMin, a.surfaceTerrainMax, a.surfaceHabitableMin, a.surfaceHabitableMax, a.villeAcquereur, a.titreAcquereur_idTitreAcquereur, a.transactionType_idTransactionType,a.user_idUser,a.comment, a.mandateStyle_idMandateStyle, a.actif, a.rechercheCity_idCity, a.rechercheSector_idSector,a.mandateType_idMandateType,a.dateInsert, a.maidenName,a.birthdate,a.birthLocation,a.nationality,a.job FROM Acquereur a WHERE a.user_idUser = ?');
	 ...
	 * @return bool op�ration r�ussie ?
	 */
	public function setMandateStyle( $mandateStyle,$execute=true)
	{
		// Sauvegarder dans l'objet
	...
	{
		$pdoStatement = $pdo->prepare('SELECT a.idAcquereur, a.name, a.firstname, a.address, a.phone, a.mobilPhone, a.workPhone, a.fax, a.email, a.numberUsed, a.priceMin, a.priceMax, a.surfaceTerrainMin, a.surfaceTerrainMax, a.surfaceHabitableMin, a.surfaceHabitableMax, a.villeAcquereur, a.titreAcquereur_idTitreAcquereur, a.transactionType_idTransactionType,a.user_idUser,a.comment, a.mandateStyle_idMandateStyle, a.actif, a.rechercheCity_idCity, a.rechercheSector_idSector,a.mandateType_idMandateType,a.dateInsert, a.maidenName,a.birthdate,a.birthLocation,a.nationality,a.job FROM Acquereur a WHERE a.mandateStyle_idMandateStyle = ?');
	...
	{
		return $this->mandateType == null?null: MandateType::load($this->pdo,$this->mandateType);
	}
	 ...
	 * @return bool op�ration r�ussie ?
	 */
	public function setMandateType( $mandateType,$execute=true)
	{
		// Sauvegarder dans l'objet
		$this->mandateType = $mandateType==null?null:$mandateType->getIdMandateType();

		// Sauvegarder dans la base de donn�es (ou pas)
		return $execute ? $this->_set(array('mandateType_idMandateType'),array($mandateType==null?null:$mandateType->getIdMandateType())) : true;
	...
	{
		$pdoStatement = $pdo->prepare('SELECT a.idAcquereur, a.name, a.firstname, a.address, a.phone, a.mobilPhone, a.workPhone, a.fax, a.email, a.numberUsed, a.priceMin, a.priceMax, a.surfaceTerrainMin, a.surfaceTerrainMax, a.surfaceHabitableMin, a.surfaceHabitableMax, a.villeAcquereur, a.titreAcquereur_idTitreAcquereur, a.transactionType_idTransactionType,a.user_idUser,a.comment, a.mandateStyle_idMandateStyle, a.actif, a.rechercheCity_idCity, a.rechercheSector_idSector,a.mandateType_idMandateType,a.dateInsert, a.maidenName,a.birthdate,a.birthLocation,a.nationality,a.job FROM Acquereur a WHERE a.mandateType_idMandateType = ?');
		if (!$pdoStatement->execute(array($mandateType->getIdMandateType()))) {
			throw new Exception('Erreur lors du chargement de tous/toutes les acquereurs par $mandateType depuis la base de donn�es');
		}
		return $pdoStatement;
	}
	...
	{
		$pdoStatement = $pdo->prepare('SELECT a.idAcquereur, a.name, a.firstname, a.address, a.phone, a.mobilPhone, a.workPhone, a.fax, a.email, a.numberUsed, a.priceMin, a.priceMax, a.surfaceTerrainMin, a.surfaceTerrainMax, a.surfaceHabitableMin, a.surfaceHabitableMax, a.villeAcquereur, a.titreAcquereur_idTitreAcquereur, a.transactionType_idTransactionType,a.user_idUser, a.comment,a.mandateStyle_idMandateStyle, a.actif, a.rechercheCity_idCity, a.rechercheSector_idSector,a.mandateType_idMandateType,a.dateInsert, a.maidenName,a.birthdate,a.birthLocation,a.nationality,a.job FROM Acquereur a WHERE a.rechercheCity_idCity = ?');
	...
	{
		$pdoStatement = $pdo->prepare('SELECT a.idAcquereur, a.name, a.firstname, a.address, a.phone, a.mobilPhone, a.workPhone, a.fax, a.email, a.numberUsed, a.priceMin, a.priceMax, a.surfaceTerrainMin, a.surfaceTerrainMax, a.surfaceHabitableMin, a.surfaceHabitableMax, a.villeAcquereur, a.titreAcquereur_idTitreAcquereur, a.transactionType_idTransactionType,a.user_idUser, a.comment, a.mandateStyle_idMandateStyle, a.actif, a.rechercheCity_idCity, a.rechercheSector_idSector,a.mandateType_idMandateType,a.dateInsert, a.maidenName,a.birthdate,a.birthLocation,a.nationality,a.job FROM Acquereur a WHERE a.rechercheSector_idSector = ?');
	...
	*/
	...
	/**
	 * D�finir le/la dateInsert
	 * @param dateInsert int
	 * @param $execute bool ex�cuter la requ�te update ?
	 * @return bool op�ration r�ussie ?
	 */
	public function setDateInsert($dateInsert,$execute=true)
	{
		// Sauvegarder dans l'objet
		$this->dateInsert = $dateInsert;
	
		// Sauvegarder dans la base de donn�es (ou pas)
		return $execute ? $this->_set(array('dateInsert'),array(date('Y-m-d H:i:s',$dateInsert))) : true;
	}
	...
	*/
	...
	/**
	 * Charger tous/toutes les acquereurs actifs
	 * @param $pdo PDO
	 * @param $easyload bool activer le chargement rapide ?
	 * @return Acquereur[] tableau de acquereurs
	 */
	...
	{
		// S�lectionner tous/toutes les acquereurs
		$pdoStatement = Acquereur::_select($pdo,'a.actif = 1');
