...
<div class="row bg-success bannerTitle">
    ...
    <div class="col-md-6">
        <p class="h4 text-right ">
            <button type="submit" class="btn {if $add}btn-success{else}btn-warning{/if}" name="valid">
                <i class="fa fa-save fa-2x"></i>
            </button>
            <a title="Annuler et fermer" class="btn btn-default" href="{Tools::create_url($user,"acquereur","list")}">
...
<fieldset>
        ...
        <div class="col-sm-8">
            <select class="form-control" name="titreAcquereur" id="titreAcquereur">
                {foreach from=$listTitre item=c}
                    <option {if $titreAcquereur eq $c->getIdTitreAcquereur()}
                        selected="selected" {/if} value="{$c->getIdTitreAcquereur()}">
                        {$c->getName()}</option> {/foreach}
            </select>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <select class="form-control" name="city" id="city">
                {foreach from=$listCity item=c}
                    <option {if $city eq $c->getIdCity()} selected="selected" {/if}
                            value="{$c->getIdCity()}"> {$c->getZipCode()} {$c->getName()}</option>
                {/foreach}
            </select>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" name="mobilPhone" value="{$mobilPhone}" id="mobilPhone" />
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label" for="workPhone">Téléphone ( travail) :</label>
        <div class="col-sm-8">
            <input type="text" class="form-control" name="workPhone" value="{$workPhone}" id="workPhone" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="fax" value="{$fax}" id="fax" class="form-control"/>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="birthdate" value="{$birthdate}" id="birthdate" class="datepicker form-control"/>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label" for="birthLocation">Lieu de naissance :</label>
        <div class="col-sm-8">
            <input type="text" name="birthLocation" value="{$birthLocation}" id="birthLocation" class="form-control"/>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" name="job" value="{$job}" id="job" />
        </div>
    </div>
</fieldset>
...
<fieldset>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <select class="form-control" name="typeTransaction" id="typeTransaction">
                {foreach from=$listTypeTransaction item=c}
                    <option {if $typeTransaction eq $c->getIdTransactionType()}
                        selected="selected" {/if} value="{$c->getIdTransactionType()}">
                        {str_replace('Vente','Achat',$c->getName())}</option> {/foreach}
            </select>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <select class="form-control" name="typeBien" id="typeBien">
                ...
                {foreach
                from=$listTypeBien item=c}
                    <option {if $typeBien eq $c->getIdMandateType()} selected="selected"
                    {/if} value="{$c->getIdMandateType()}"> {$c->getName()}</option>
                {/foreach}
            </select>
        </div>
    </div>
    <div class="form-group" id="pStyle">
        ...
        <div class="col-sm-8">
            <select class="form-control" name="style" id="style">
                <option value="undefined" {if $style
                eq 'undefined'} selected="selected"{/if}>Indifférent</option>
                {foreach from=$listStyle item=c}
                    <option {if $style eq $c->getIdMandateStyle()} selected="selected"
                    {/if} value="{$c->getIdMandateStyle()}"> {$c->getName()}</option>
                {/foreach}
            </select>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="prixMin" id="prixMin" value="{$prixMin}" class="form-control" />
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label" for="prixMax">Prix maximum : </label>
        <div class="col-sm-8">
            <input class="form-control" type="text" name="prixMax" id="prixMax" value="{$prixMax}" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input class="form-control" type="text" name="surfaceTmin" id="surfaceTmin" value="{$surfaceTmin}" />
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label" for="surfaceTmax">Surface terrain Maximum :</label>
        <div class="col-sm-8">
            <input type="text" class="form-control" name="surfaceTmax" id="surfaceTmax" value="{$surfaceTmax}" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="surfaceHmin" id="surfaceHmin" value="{$surfaceHmin}" class="form-control" />
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label" for="surfaceHmax">Surface habitable Maximum :</label>
        <div class="col-sm-8">
        <input class="form-control" type="text" name="surfaceHmax" id="surfaceHmax" value="{$surfaceHmax}" />
            </div>
    </div>
    ...
    <div class="form-group">
        ...
        <select class="form-control" name="sector" id="sector">
            <option value="undefined" {if $sector
            eq 'undefined'} selected="selected"{/if}>Indifférent</option>
            {foreach from=$listSector item=c}
                <option {if $sector eq $c->getIdSector()} selected="selected" {/if}
                        value="{$c->getIdSector()}"> {$c->getName()}</option> {/foreach}
        </select>
            </div>
    </div>
    <div class="form-group">
        ...
        <select class="form-control" name="rCity" id="rCity">
            <option value="undefined" {if $rCity
            eq 'undefined'} selected="selected"{/if}>Indifférent</option>
            {foreach from=$listCity item=c}
                <option {if $rCity eq $c->getIdCity()} selected="selected" {/if}
                        value="{$c->getIdCity()}"> {$c->getZipCode()} {$c->getName()}</option>
            {/foreach}
        </select>
            </div>
...
<div class="form-group">
    <div class="col-sm-offset-2 col-sm-8">
        ...
        <a class="btn btn-default" href="{Tools::create_url($user,"acquereur","list")}">
