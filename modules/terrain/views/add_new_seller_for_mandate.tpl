...
<div class="row bg-success bannerTitle">
    <div class="col-md-6">
        <h1 class="h2">Ajouter un vendeur au terrain : {$mandate->getNumberMandate()}</h1>
    </div>

    <div class="col-md-6">
        <p class="h4 text-right ">

            <a title="annuler et fermer" class="btn btn-default" href="{Tools::create_url($user,"terrain","see",$smarty.get.action)}">
