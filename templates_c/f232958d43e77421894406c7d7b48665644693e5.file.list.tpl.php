<?php /* Smarty version Smarty-3.0.6, created on 2012-07-19 09:43:52
         compiled from "/var/www/aptana/extra-immo/modules/terrain/modules/action/views/list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18606642085007bab8359749-62037684%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f232958d43e77421894406c7d7b48665644693e5' => 
    array (
      0 => '/var/www/aptana/extra-immo/modules/terrain/modules/action/views/list.tpl',
      1 => 1325173675,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18606642085007bab8359749-62037684',
  'function' => 
  array (
  ),
...
?>
			<tr>
				...
				<!--	<td><?php if ($_smarty_tpl->getVariable('i')->value->getDeadDate()){?><?php echo date(Constant::DATE_FORMAT2,$_smarty_tpl->getVariable('i')->value->getDeadDate());?>
<?php }?></td>-->
...
" <?php if ($_smarty_tpl->getVariable('user')->value->getOpenInNewTab()){?> target="_blank"<?php }?>>Voir</a>
				</td>
			</tr>
			<?php }} ?>
		</tbody>
